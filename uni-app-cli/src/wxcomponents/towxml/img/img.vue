<template>
<uni-shadow-root class="towxml-img-img"><image :class="attrs.class" lazy-load="true" :mode="attrs.mode || 'widthFix'" :src="attrs.src" :style="(attrs.style)+' width:'+(size.w)+'px;height:'+(size.h)+'px;'" @load="load"></image></uni-shadow-root>
</template>

<script>

global['__wxRoute'] = 'towxml/img/img'
...
export default global['__wxComponents']['towxml/img/img']
</script>
